...
<style>
  ...
  .ratings .overview .overview-left {
    ...
    padding: 6px 0;
    width: 137px;
    border-right: 2px solid rgba(7, 17, 27,0.2);
    text-align: center;
  }
  ...
  .ratings .rating-item .content .star-wrapper {
    margin-bottom: 6px;
    font-size: 0;
  }
  .ratings .rating-item .content .star {
    display: inline-block;
    margin-right: 6px;
    vertical-align: top;
  }
  .ratings .rating-item .content .delivery {
	display: inline-block;
	vertical-align: top;
	line-height: 12px;
	font-size: 10px;
  ...
  .ratings .rating-item .content .recommend {
    line-height: 16px;
    font-size: 0;
  }
  .ratings .rating-item .content .recommend .icon-thumb_up, .item {
	display: inline-block;
	margin: 0 8px 4px 0;
	font-size: 9px;
  }
  .ratings .rating-item .content .recommend .icon-thumb_up {
    color: rgb(0, 160, 220);
  }
  .ratings .rating-item .content .recommend .item {
    padding: 0 6px;
  ...
  .ratings .rating-item .content .time {
	position: absolute;
	top: 0;
	right: 0;
	line-height: 12px;
