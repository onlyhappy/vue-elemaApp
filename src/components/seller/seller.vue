...
<style>
  ...
  .seller .overview .remark .block {
   ...
   .seller .seller-content .favorite {
     position: absolute;
     width: 50px;
     right: 11px;
     top: 18px;
   ...
   .seller .seller-content .favorite .icon-favorite {
     display: block;
     margin-bottom: 4px;
     line-height: 24p;
     font-size: 24px;
   ...
   .seller .seller-content .icon-favorite.active{
     color: rgb(240, 20, 20);
   }
   .seller .seller-content .favorite .text {
     line-height: 10px;
     font-size: 10px;
     color: rgb(77, 85, 93);
   }
   ...
   .seller .seller-content .pics .pic-list .pic-item:last-child {
     margin: 0;
   }
