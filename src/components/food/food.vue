...
<style>
  ...
  .food .food-content .info .title {
   ...
   .food .rating-wrapper .icon-thumb_up,.icon-thumb_down {
     margin-right: 4px;
     line-height: 16px;
     font-size: 12px;
   }
   .food .rating-wrapper .icon-thumb_up {
     color: rgb(0, 160, 220);
   }
   .food .rating-wrapper .icon-thumb_down {
     color: rgb(147, 153, 159);
   }
